...
const Sommelier : React.FC = (props) => {
    const data_resto = useContext(data).restaurants;
    const des1 = data_resto.duSommelier.description;
    const des2 = data_resto.duSommelier.description2;
    return(<View style={styles.container}>
              <ImageBackground source={require("../../assets/images/background.png")} style={styles.bg}>
                <View style={styles.main}>
                    <Title title={data_resto.duSommelier.Title}></Title>
                    <View style={styles.image}>
                      <Image
                      source={data_resto.duSommelier.img}
                      />
                    </View>
