...
const Tourteau : React.FC = (props) => {
    const data_recette = useContext(data).recipes;
    const des1 = data_recette.tourteau.description;
    const des2 = data_recette.tourteau.description2;
    return(<View style={styles.container}>
              <ImageBackground source={require("../../assets/images/background.png")} style={styles.bg}>
                <View style={styles.main}>
                    <Title title={data_recette.tourteau.Title}></Title>
                    <View style={styles.image}>
                      <Image
                      source={data_recette.tourteau.img}
                      />
                    </View>
