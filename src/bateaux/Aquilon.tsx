...
const Aquilon: React.FC = (props) => {
    const data_ship = useContext(data).ship;
    const des1 = data_ship.aquilon.description;
    const des2 = data_ship.aquilon.description2;
    return(<View style={styles.container}>
              <ImageBackground source={require("../../assets/images/background.png")} style={styles.bg}>
                <View style={styles.main}>
                    <Title title={data_ship.aquilon.Title}></Title>
                    <View style={styles.image}>
                      <Image
                      source={data_ship.aquilon.img}
                      />
                    </View>
                    <View style={styles.legend}>
                      <Text>{data_ship.aquilon.legend}</Text>
                    </View>
